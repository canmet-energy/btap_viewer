    ...
    html.Div([
        dbc.Tabs(
            [
                ...
                dbc.Tab(label='Tier Costs', children=[dcc.Graph(id='tiered_costs_graph')])
...
@app.callback(
    ...
    # Update Sensitivity Figure
    Output(component_id='tiered_costs_graph', component_property='figure'),
